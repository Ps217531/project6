...
class ProductController extends Controller
{
    ...
    public function sync(Request $request, $order_id)
    {
        try {
            ...
            $response = Http::withToken($token)->get('http://kuin.summaict.nl/api/orderItem?order_id=' . $order_id);
            ...
            foreach ($orderItems as $orderItem) {
                ...
                $productResponse = Http::withToken($token)->get('http://kuin.summaict.nl/api/product/' . $productId);
                ...
                $products = $checkResponse->json()['data']['data'];

                $product = null;

                foreach ($products as $apiProduct) {
                    if ($apiProduct['article_number'] === $productId) {
                        $product = $apiProduct;
                        break;
                    }
                }
